    ...
    <div className={`${className}`}>
      <div className=''>
        ...
        <div className='relative'>
          {textarea ? (
            <textarea
              className={`w-full h-40 px-3.5 py-3 bg-n-2 border-2 border-n-2 rounded-xl base2  text-n-7 outline-none transition-colors placeholder:text-n-4/50 focus:bg-transparent resize-none dark:bg-n-6 dark:border-n-6 dark:text-n-3 dark:focus:bg-transparent ${
                icon && 'pl-[3.125rem]'
