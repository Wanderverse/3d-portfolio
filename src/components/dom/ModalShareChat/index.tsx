...
import Field from '@/components/dom/Field'
import MultiSelect from '@/components/dom/MultiSelect'
  ...
  return (
    ...
    >
      <form className='p-12 md:p-5' action='' onSubmit={() => console.log('Submit')}>
        ...
        <div className='mb-4 base2 font-semibold text-n-6 dark:text-n-3'>Copy link</div>
        <div className='relative mb-8'>
          ...
          <CopyToClipboard text={link} onCopy={onCopy}>
            <button className='btn-dark absolute top-1 right-1' ref={copyButtonRef} type='button'>
              Copy
            </button>
          </CopyToClipboard>
        </div>
        <div className='mb-4 base2 font-semibold text-n-6 dark:text-n-3'>Or share to members</div>
        <MultiSelect
          className='mb-8'
          items={people}
