  ...
  return (
    <Transition show={visible} as={Fragment}>
      ...
      >
        ...
        >
          <div
            className={`fixed inset-0 ${video ? 'bg-n-7/95' : 'bg-n-7/75 dark:bg-n-6/90'} ${classOverlay}`}
            aria-hidden='true'
          />
        </Transition.Child>
        <Transition.Child
        ...
        >
          <Dialog.Panel
            className={twMerge(
              `relative z-10 max-w-[50rem] md:max-w-[37.5rem] w-full m-auto bg-n-1 rounded-3xl dark:bg-n-7 ${
                video &&
