...
const Message = ({ value, onChange, placeholder, image, document, onSubmit, onEnter }: MessageProps) => {
  const stylesButton = 'group absolute right-3 bottom-2 w-10 h-10'

  return (
    <div className='relative z-5 px-10 pb-6 before:absolute before:-top-6 before:left-0 before:right-6 before:bottom-1/2 before:bg-gradient-to-b before:to-n-1 before:from-n-1/0 before:pointer-events-none 2xl:px-6 2xl:pb-5  dark:before:to-n-6 dark:before:from-n-6/0'>
